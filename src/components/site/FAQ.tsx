    ...
    <section id="faq" className="py-10 md:py-14 bg-secondary/40">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <button
          onClick={() => setOpen((v) => !v)}
          aria-expanded={open}
          className="group w-full rounded-2xl bg-gradient-to-r from-foreground to-foreground/90 text-background px-6 py-5 md:py-6 shadow-elev hover:shadow-soft transition-all flex items-center gap-4"
        >
