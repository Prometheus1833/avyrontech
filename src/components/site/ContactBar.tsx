...
const ContactBar = () => {
  return (
    <div className="fixed bottom-3 right-3 md:bottom-4 md:right-4 z-40 flex flex-col gap-1.5 md:gap-2">
      <a
      ...
      <a
        ...
        className="size-10 md:size-12 rounded-full bg-gradient-to-br from-[#0078FF] via-[#A033FF] to-[#FF5A5A] text-white grid place-items-center shadow-elev hover:scale-110 transition-transform"
      >
        <MessengerIcon className="size-4 md:size-5" />
      </a>
      <a
