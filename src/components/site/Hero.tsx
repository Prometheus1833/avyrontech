  ...
  return (
    <section id="top" className="relative pt-24 pb-12 md:pt-36 md:pb-24 overflow-hidden bg-hero">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 text-center flex flex-col items-center">
        ...
        <div className="mt-10 md:mt-12 flex flex-wrap items-center gap-x-6 gap-y-3 text-xs sm:text-sm text-muted-foreground justify-center">
          {t.hero.stats.map((s, i) => (
            <div key={i} className="flex items-center gap-x-6">
              <div><span className="font-display font-bold text-foreground text-xl sm:text-2xl">{s.v}</span> {s.l}</div>
