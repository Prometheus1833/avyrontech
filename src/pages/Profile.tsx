...
const Profile = () => {
  ...
  const handleAvatar = async (file: File) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      toast.error("Fișierul depășește 5MB");
      return;
    }
    setUploading(true);
  ...
  return (
    <main className="min-h-screen bg-secondary/30 py-12 px-4">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="space-y-1">
          <h1 className="font-display text-3xl font-bold">{t.auth.profile.title}</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t.auth.profile.avatar}</CardTitle>
          </CardHeader>
          <CardContent className="flex items-center gap-4">
            <Avatar className="size-20">
              <AvatarImage src={profile?.avatar_url ?? undefined} />
              <AvatarFallback className="bg-gradient-to-br from-foreground to-brand text-background">
                {initials}
              </AvatarFallback>
            </Avatar>
            <div>
              ...
              <Button variant="outline" onClick={() => fileRef.current?.click()} disabled={uploading}>
                ...
                {uploading ? "..." : t.auth.profile.changeAvatar}
              </Button>
          ...
          <CardContent className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, entity_type: v as typeof form.entity_type })}
              >
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t.auth.profile.socials}</CardTitle>
          </CardHeader>
          <CardContent className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              <Label>{t.auth.profile.website}</Label>
              <Input
                placeholder="https://..."
                value={form.website}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Preferințe</CardTitle>
          </CardHeader>
          <CardContent className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Select
                value={form.language}
                onValueChange={(v) => setForm({ ...form, language: v as "ro" | "en" })}
              >
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={form.theme}
                onValueChange={(v) => setForm({ ...form, theme: v as typeof form.theme })}
              >
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
