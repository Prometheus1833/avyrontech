  ...
  ro: {
    ...
    problem: {
      ...
      items: [
        ...
        { t: "Pare complicat", d: "Crezi că un site e greu de administrat. Noi ne ocupăm de tot, sau te ghidăm pas cu pas cum să îl administrezi ulterior singur." },
        { t: "Credibilitate fragilă", d: "Fără un site oficial, clienții se îndoiesc dacă ești o afacere reală și serioasă." },
    ...
    cta: {
      ...
      bullets: ["✓ Mockup vizual personalizat", "✓ Recomandări strategice", "✓ Estimare de timp și buget"],
      name: "Nume",
      namePh: "Ion Popescu",
  ...
  en: {
    ...
    problem: {
      ...
      items: [
        ...
        { t: "Sounds complicated", d: "You think a site is hard to manage. We handle everything, or guide you step by step to manage it yourself." },
        { t: "Fragile credibility", d: "Without an official site, clients doubt whether you're a real, serious business." },
    ...
    cta: {
      ...
      bullets: ["✓ Custom visual mockup", "✓ Strategic recommendations", "✓ Time and budget estimate"],
      name: "Name",
      namePh: "John Doe",
