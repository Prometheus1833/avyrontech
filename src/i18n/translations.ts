...
export const translations = {
  ro: {
    ...
    processPage: {
      eyebrow: "Procesul Avyron",
      metaTitle: "Procesul de lucru — de la prima discuție la site live | Avyron",
      metaDescription:
        "Cum lucrăm la Avyron: patru etape clare, de la prima discuție la predare și mentenanță. Fără jargon, fără costuri ascunse, cu actualizări pe tot parcursul.",
      lead: "Patru etape, fără surprize. Tu ne spui unde vrei să ajungi, noi ducem proiectul acolo.",
      scrollHint: "Derulează",
      durationLabel: "Durată",
      youLabel: "Ce faci tu",
      usLabel: "Ce facem noi",
      outputLabel: "Ce primești",
      stepLabel: "Etapa",
      detail: [
        {
          duration: "30 de minute",
          you: "Ne spui ce faci, cui te adresezi și ce vrei să obții. Nu ai nevoie de un brief scris.",
          us: "Punem întrebările care contează și îți spunem direct ce e realist în bugetul tău.",
          output: "O direcție clară și un interval de preț, fără obligații.",
        },
        {
          duration: "2–3 zile",
          you: "Citești oferta și ne spui ce îți place și ce nu.",
          us: "Pregătim propunerea completă: structură, design, funcționalități, conturi demonstrative.",
          output: "O ofertă pe hârtie, cu preț final și termen exact.",
        },
        {
          duration: "5–15 zile",
          you: "Aprobi etapele pe măsură ce le vezi. Nimic nu se construiește pe ascuns.",
          us: "Dezvoltăm, testăm și îți trimitem actualizări periodice cu link live.",
          output: "Un produs funcțional, testat pe desktop și pe telefon.",
        },
        {
          duration: "1 zi",
          you: "Alegi: preiei tu administrarea sau o lăsăm în grija noastră.",
          us: "Predăm credențialele, explicăm tot și rămânem disponibili pentru mentenanță.",
          output: "Site-ul live, pe domeniul tău, cu acces complet.",
        },
      ],
      advantagesTitle: "De ce e simplu de partea ta",
      advantages: [
        { t: "Un singur interlocutor", d: "Vorbești cu aceeași persoană de la prima discuție până la predare. Fără să repeți contextul." },
        { t: "Preț fix, agreat înainte", d: "Suma din ofertă este suma pe care o plătești. Fără costuri care apar pe parcurs." },
        { t: "Vezi progresul, nu promisiuni", d: "Primești link live la fiecare etapă. Știi mereu unde s-a ajuns." },
        { t: "Fără jargon tehnic", d: "Îți explicăm fiecare decizie în cuvinte normale. Nu trebuie să înțelegi cod ca să decizi." },
        { t: "Rămâi proprietar pe tot", d: "Domeniul, conturile și codul sunt ale tale. Poți pleca oricând, cu tot cu produs." },
        { t: "Nu dispărem la lansare", d: "Mentenanța e opțională, dar suntem acolo dacă apare ceva. Răspundem, nu ignorăm." },
      ],
      ctaTitle: "Începem cu o discuție de 30 de minute.",
      ctaBody: "Fără prezentare de vânzări. Ne spui ce ai nevoie, îți spunem dacă și cum putem ajuta.",
      ctaButton: "Hai să vorbim",
    ...
    cta: {
      badge: "Exemplu Gratuit",
      title: "Vrei să vezi cum ar arăta site-ul tău?",
      desc: "Primești gratuit un raport complet + un exemplu personalizat — fără obligații, fără cost.",
      bullets: [
        "✓ Audit website actual: design, funcționalitate, securitate",
        "✓ Verificare accesibilitate UI/UX și testare în condiții reale",
        "✓ Analiză de piață în nișa ta + recomandări strategice",
        "✓ Exemplu vizual+funcțional personalizat și estimare buget",
      ],
      name: "Nume",
      ...
      descriptionPh: "Spune-ne pe scurt ce faci.",
      files: "Imagini sau documente (opțional)",
      filesHint: "Max 5 fișiere · 10MB/fișier",
      filesAdd: "Adaugă fișiere",
      submit: "Vreau exemplu gratuit",
      sending: "Se trimite...",
      success: "Mulțumim! Te contactăm în maxim 24 de ore cu exemplul tău gratuit.",
      successTitle: "Solicitare trimisă cu succes",
      successDesc: "Am primit cererea ta. Te contactăm în maxim 24 de ore cu raportul și exemplul personalizat.",
      summaryTitle: "Rezumatul datelor trimise",
      summaryRef: "Referință",
      summaryNoFiles: "Fără fișiere",
      sendAnother: "Trimite altă solicitare",
      rateLimited: "Ai trimis deja o solicitare recent. Te rugăm să încerci din nou mai târziu.",
      captchaFailed: "Verificarea anti-spam a eșuat. Reîncarcă pagina și încearcă din nou.",
      captchaRequired: "Te rugăm să confirmi verificarea anti-spam.",
      sendError: "Trimiterea a eșuat. Încearcă din nou sau scrie-ne pe email.",
  ...
  en: {
    ...
    processPage: {
      eyebrow: "The Avyron process",
      metaTitle: "Our process — from first conversation to a live site | Avyron",
      metaDescription:
        "How we work at Avyron: four clear stages, from the first conversation to delivery and maintenance. No jargon, no hidden costs, updates throughout.",
      lead: "Four stages, no surprises. You tell us where you want to get to; we take the project there.",
      scrollHint: "Scroll",
      ...
      detail: [
        {
          duration: "30 minutes",
          you: "Tell us what you do, who you serve and what you want to achieve. No written brief needed.",
          us: "We ask the questions that matter and tell you straight what is realistic on your budget.",
          output: "A clear direction and a price range, with no obligation.",
        },
        {
          duration: "2–3 days",
          you: "Read the proposal and tell us what works and what doesn't.",
          us: "We prepare the full proposal: structure, design, features, demo accounts.",
          output: "A written offer, with a final price and an exact deadline.",
        },
        {
          duration: "5–15 days",
          you: "Approve each stage as you see it. Nothing gets built out of sight.",
          us: "We build, test and send you regular updates with a live link.",
          output: "A working product, tested on desktop and phone.",
        },
        {
          duration: "1 day",
          you: "Choose: take over the admin yourself, or leave it with us.",
          us: "We hand over credentials, walk you through everything and stay available for maintenance.",
          output: "Your site live, on your domain, with full access.",
        },
      ],
      advantagesTitle: "Why it stays simple on your side",
      advantages: [
        { t: "One person to talk to", d: "You speak to the same person from the first conversation to handover. No repeating context." },
        { t: "Fixed price, agreed upfront", d: "The figure in the offer is the figure you pay. No costs appearing along the way." },
        { t: "See progress, not promises", d: "You get a live link at every stage. You always know where things stand." },
        { t: "No technical jargon", d: "We explain every decision in plain words. You don't need to read code to decide." },
        { t: "You own everything", d: "The domain, the accounts and the code are yours. You can leave any time, product included." },
        { t: "We don't vanish at launch", d: "Maintenance is optional, but we're there if something comes up. We answer, we don't ignore." },
      ],
      ctaTitle: "It starts with a 30-minute conversation.",
      ctaBody: "No sales pitch. You tell us what you need, we tell you whether and how we can help.",
    ...
    cta: {
      ...
      desc: "Get a complete report + a personalized example — no obligations, no cost.",
      bullets: [
        "✓ Free audit of your current site: design, functionality, security",
        "✓ UI/UX accessibility check and real-world testing",
        "✓ Market analysis in your niche + strategic recommendations",
        "✓ Personalized visual+functional example and budget estimate",
      ],
      name: "Name",
      namePh: "John Doe",
      ...
      descriptionPh: "Tell us briefly what you do.",
      files: "Images or documents (optional)",
      filesHint: "Max 5 files · 10MB each",
      filesAdd: "Add files",
      submit: "I want a free example",
      sending: "Sending...",
      success: "Thanks! We'll contact you within 24 hours with your free example.",
      successTitle: "Request sent successfully",
      successDesc: "We received your request. We'll get back to you within 24 hours with the report and your personalized example.",
      summaryTitle: "Summary of submitted details",
      summaryRef: "Reference",
      summaryNoFiles: "No files",
      sendAnother: "Send another request",
      rateLimited: "You already sent a request recently. Please try again later.",
      captchaFailed: "Anti-spam verification failed. Reload the page and try again.",
      captchaRequired: "Please complete the anti-spam check.",
      sendError: "Sending failed. Please try again or email us.",
