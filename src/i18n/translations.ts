...
export const translations = {
  ro: {
    ...
    cta: {
      ...
      descriptionPh: "Spune-ne pe scurt ce faci și ce ți-ai dori de la site.",
      files: "Imagini sau documente (opțional)",
      filesHint: "Max 5 fișiere · 10MB / fișier · imagini, PDF, DOC",
  ...
  en: {
    ...
    cta: {
      ...
      descriptionPh: "Tell us briefly what you do and what you'd like from the site.",
      files: "Images or documents (optional)",
      filesHint: "Max 5 files · 10MB each · images, PDF, DOC",
      filesAdd: "Add files",
