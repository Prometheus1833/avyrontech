...
export const translations = {
  ro: {
    ...
    hero: {
      badge: "Agenție web Iași · site-uri pentru afaceri din România și UE",
      title1: "Site-uri de prezentare",
      title2: "și produse digitale",
      title3: "construite pentru creștere.",
      subtitle:
        "Creăm website-uri profesionale, magazine online și aplicații web/mobile cu design custom, SEO tehnic, performanță, securitate și infrastructură Cloudflare — adaptate firmei și clienților tăi.",
  ...
  en: {
    ...
    hero: {
      badge: "Web agency in Iași · digital products for Romania and the EU",
      title1: "Business websites",
      title2: "and digital products",
      title3: "built for growth.",
      subtitle:
        "We build professional websites, online stores, and web/mobile applications with custom design, technical SEO, performance, security, and Cloudflare infrastructure—tailored to your business and customers.",
    ...
    footer: {
      ...
      navItems: [
        { l: "Blog", h: "/en/blog" },
        { l: "Portfolio", h: "/en/about#portofoliu" },
        { l: "See examples", h: "/en#exemple" },
        { l: "Products", h: "/en/pricing" },
        { l: "Process", h: "/en#proces" },
        { l: "FAQ", h: "/en#faq" },
