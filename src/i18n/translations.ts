  ...
  ro: {
    ...
    process: {
      ...
      steps: [
        ...
        { t: "Predare & mentenanță", d: "Produsul final este prezentat. Primești credențialele de acces sau, la cerere, echipa Webcore îl administrează în continuare." },
      ],
    },
    domain: {
      ...
      desc: "Introdu numele business-ului și vezi instant pe ce extensii e disponibil.",
    ...
    footer: {
      ...
      copy: "© {y} Webcore. Toate drepturile rezervate.",
      built: "Construit cu pasiune în România.",
    },
    seo: {
      title: "Webcore — Site-uri care aduc clienți | Vizibilitate online",
      desc: "Construim site-uri profesioniste, rapide și optimizate pentru Google, în 2-5 zile. Pentru afaceri locale, restaurante, saloane, profesii liberale.",
    },
  },
  en: {
    nav: {
