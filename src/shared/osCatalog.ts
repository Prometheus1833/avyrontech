...
export const centers = [
  ...
  {id:'backup',name:'Backup & Recovery',group:'Infrastructură și securitate',detail:'Copii automate D1/R2, retenție, bază protejată și recuperare controlată.',roles:[]},
...
export const ownerOnly: readonly CenterId[] = ['accounts','approvals','runs','automations','contracts','changes','appointments','integrations','security','backup','documents','vault','plugins','privacy','compliance','experiments'];
