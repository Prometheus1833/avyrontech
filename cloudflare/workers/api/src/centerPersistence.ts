...
export const fail=(c:Ctx,code:string,status:400|403|404|409|503=400)=>c.json({error:{code,message:({forbidden:'Nu ai acces la această funcție.',revision_conflict:'Datele au fost modificate. Reîncarcă înainte de a salva.',invalid_input:'Verifică toate câmpurile obligatorii.',consent_required:'Este necesară dovada consimțământului.',not_found:'Înregistrarea nu există.',account_not_verified:'Verifică mai întâi contul în Conturi & dispozitive.',account_unavailable_or_expired:'Contul este dezactivat sau credentialul a expirat.',brand_mismatch:'Contul și campania trebuie să aparțină aceluiași brand.',approval_required:'Este necesară aprobarea versiunii curente.',post_locked_or_stale:'Postarea este în procesare sau a fost modificată. Reîncarcă lista.',day_already_recorded:'Rezultatele acestei zile au fost deja înregistrate.',verified_cloudflare_account_required:'Configurează și verifică un cont Cloudflare cu acces la baza de date.',backup_in_progress:'Există deja un backup sau o curățare în desfășurare.',media_required:'Adaugă URL-ul public al imaginii sau videoclipului.',reel_video_required:'Un reel necesită un videoclip.',use_reel_for_instagram_video:'Pentru video Instagram selectează formatul reel.',facebook_story_reel_assisted_required:'Folosește publicarea asistată pentru Facebook stories și reels.',facebook_video_assisted_required:'Folosește publicarea asistată pentru videoclipurile Facebook.',device_not_online:'Dispozitivul nu este online. Deschide secțiunea Conturi & dispozitive pe el.',future_schedule_required:'Selectează un moment cu cel puțin un minut în viitor.',public_https_media_required:'Materialul trebuie să aibă un URL HTTPS public.',complete_export_required:'Confirmă listele complete și data exportului.',empty_or_unrecognized_export:'Exportul este gol sau nu conține liste recunoscute.'} as Record<string,string>)[code]||code}},status);
